...
//Lexical Tokens
%token <string> TRACEFILE TRACECOUNT SEQLENGTH DELAYRES DEPTH EXDEPTH BESTCOUNT TMAX TMIN START PBEGIN PEND TARGET OPENROUND CLOSEROUND ATPOSEDGE ATNEGEDGE ATANYEDGE RATIONAL ARITHOP EQ LEQ GEQ LT GT SEMICOLON DOLLARTIME ATOM BAND BOR EEQ PREDLEARN COMMA;
...
%type <string> rational arithExpr arithStatement traceFile traceFileList sequenceLength delayResolution bestGainCount tempMax tempMin treeDepth treeExDepth learningType traceCT;
