...
void prepareRoot(struct treeNode* root,struct listOfIntervalListsStruct** intervalSet, struct listOfIntervalListsStruct** learnedIntervalSets, int target, int numberOfPORVs,int N);
void choicePause();
