...
gcc structs.c amsMinerStructs.c  lex.predToPy.c predToPy.tab.c lex.intervalList.c intervalList.tab.c lex.learnedOP.c learnedOP.tab.c amsMiner.c  -o psiMiner -lm 
